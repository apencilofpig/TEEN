...
from .helper import *
from .Network import ID_FSCIL, MYNET
...
class FSCILTrainer(Trainer):
    ...
    def set_up_model(self):
        input_dim = 51
        hidden_dim = 512
        base_classes = self.args.base_class
        new_classes = self.args.num_classes - self.args.base_class
        self.model = ID_FSCIL(input_dim, hidden_dim, base_classes, new_classes)
